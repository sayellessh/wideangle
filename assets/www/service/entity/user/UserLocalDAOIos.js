com.swaas.hidoctor.edetailing.dao.UserLocalDAO = {
		...
		insert: function(user, onSuccess, onFailure){
			/*return com.swaas.hidoctor.edetailing.dao.CoreDAO.insert(this, user);*/
            com.swaas.hidoctor.edetailing.dao.CoreDAO.insert(this, user, onSuccess, onFailure);
		},
		...
		remove: function(userCode, onSuccess, onFailure){
			/*var criteria = {};
		...
		get: function(userCode, onSuccess, onFailure){
            var criteria = {};
			criteria.userCode = userCode;
