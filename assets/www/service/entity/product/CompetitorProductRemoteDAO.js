com.swaas.hidoctor.edetailing.dao.CompetitorProductRemoteDAO = {
		metadata: {
		...
		get: function(correlationId, subDomainName, companyCode, userCode){
			...
			var result = com.swaas.hidoctor.edetailing.dao.CoreSOAP.invokeGet(this, "GetCompetitorProducts", data);
			return result;
		},
