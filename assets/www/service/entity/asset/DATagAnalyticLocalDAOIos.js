com.swaas.hidoctor.edetailing.dao.DATagAnalyticLocalDAO = {
		...
		insert: function(daAnalytics, onSuccess){ var _this = this;
			com.swaas.hidoctor.edetailing.dao.SynchronizeLocalDAO.updateUpSyncRequired(true, function(){
                com.swaas.hidoctor.edetailing.dao.CoreDAO.insert(_this, daAnalytics, onSuccess);
            });
        },
				
		remove: function(daTagAnalyticId,onSuccess,onFailure){
			var criteria = {};
