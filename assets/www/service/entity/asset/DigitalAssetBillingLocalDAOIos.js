com.swaas.hidoctor.edetailing.dao.DigitalAssetBillingLocalDAO = {
		...
		insert: function(digitalAssetBilling, onSuccess, onFailure){
			com.swaas.hidoctor.edetailing.dao.SynchronizeLocalDAO.updateUpSyncRequired(true, function(){ 
				com.swaas.hidoctor.edetailing.dao.CoreDAO.insert(com.swaas.hidoctor.edetailing.dao.DigitalAssetBillingLocalDAO, digitalAssetBilling, onSuccess, onFailure);
            });
			//return
		},
		...
		update : function(daBillingId, documentViewTime,onSuccess,onFailure){
			com.swaas.hidoctor.edetailing.dao.CoreDAO.update(this, {daBillingId : daBillingId, playTime : documentViewTime},onSuccess,onFailure);
		}
};