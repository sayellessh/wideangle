com.swaas.hidoctor.edetailing.dao.CoreSOAP = {
		...
		errorHandler: null,
		invoke: function(daoClass, operation, params, returnType, success){
		...
		invokeGet: function(daoClass, operation, params, returnType, rootElement, success){
			if (returnType == null || returnType == 'undefined'){
				returnType = 'json';
			}
			var result = this.invoke(daoClass, operation, params, returnType, success);
			if (returnType == 'json'){
